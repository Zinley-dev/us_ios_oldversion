...
class ChallengeModel {
    ...
    var started_timeStamp: Timestamp! {
        get {
            if _started_timeStamp == nil {
                _started_timeStamp = Timestamp.init(date: NSDate() as Date)
            }
    ...
    var updated_timeStamp: Timestamp! {
        get {
            if _updated_timeStamp == nil {
                _updated_timeStamp =  Timestamp.init(date: NSDate() as Date)
            }
    ...
    var created_timeStamp: Timestamp! {
        get {
            if _created_timeStamp == nil {
                _created_timeStamp = Timestamp.init(date: NSDate() as Date)
            }
    ...
    init(postKey: String, Challenge_model: Dictionary<String, Any>) {
        ...
        if let highlight_Id = Challenge_model["highlight_Id"] as? String {
